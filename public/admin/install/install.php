...
$dbHost = $dbUser = $dbPass = $dbName = $dbPrefix = $item_purchase_code = $readOnly = '';
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Pinky Live Chat | Installer panel</title>
    ...
    <link href="https://prothemes.biz/lic/api/pinky/css.php?site=<?php echo $baseLink; ?>" rel="stylesheet" type="text/css" />
    
    <!-- Theme style -->
    <link href="<?php echo $themeLink; ?>dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $themeLink; ?>dist/css/custom.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $themeLink; ?>dist/css/skins/skin-pink.min.css" rel="stylesheet" type="text/css" />
  ...
  <body class="skin-blue sidebar-mini sidebar-collapse hold-transition">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="logo">
          ...
          <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><span class="livechat icon-bubbles3"></span> Pinky <b>Chat</b></span>
        </a>
            ...
            <div id="index_0">  
              ...
              <div class="box box-primary">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>1</td>
                        <td>Configuration File <small>("/core/config/config.php")</small></td>
                        <?php
                        if (is_writable(CONFIG_DIR.'config.php')) {
                    ...
                    <tr>
                        <td>5</td>
                        <td>Profile Avatars Directory <small>("/resources/avatars/")</small></td>
                        <?php   
                        if (is_writable(ROOT_DIR.'resources'.DIRECTORY_SEPARATOR.'avatars')) {
                            echo '<td><span class="label label-success">Writable</span></td>';
                        } else {
                            echo '<td><span class="label label-danger">Not Writable</span></td>';
                                $fa = '1';
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="data_prefix">Table Prefix </label> &nbsp; <small>(Optional)</small>
                            <input <?php echo $readOnly; ?> value="<?php echo $dbPrefix; ?>" type="text" placeholder="Enter your table prefix" name="data_prefix" id="data_prefix" class="form-control">
                        </div>
                        <div class="form-group">
                 ...
                 <div class="box-header"> <br />
                    <h3 class="box-title">License Verification</h3>
                        ...
                        <div class="form-group">
                            <label for="data_sec">Item Purchase Code &nbsp; <small><a target="_blank" href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-can-I-find-my-Purchase-Code-">(Where can I find my Purchase Code?)</a>  &nbsp; | &nbsp; <a target="_blank" href="http://api.prothemes.biz/pinky/reset.php">(Reset Domain Name)</a></small></label>
    ...
    var sql_prefix = $('input[name=data_prefix]').val();
    ...
    $.post("<?php echo $processLink; ?>", {data_prefix:sql_prefix, data_host:sql_host,data_name:sql_name,data_user:sql_user,data_pass:sql_pass,data_sec:sql_sec,data_domain:data_domain}, function(results){
    if (results == 1) {
         $("#alert1").hide();
         $("#alert2").show();
         $("#index_1").hide();
